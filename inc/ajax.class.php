<?php
/*
 * @version $Id: ajax.class.php 22657 2014-02-12 16:17:54Z moyo $
 -------------------------------------------------------------------------
 ...
 * 
 * Fichier ajouté dans le but de rendre compatible les "dropdown" à partir 
 * de la version 0.85 de GLPI, car la fonction "Ajax::dropdown" à été
 * à partir de cette version. Appeller ce fichier si besoin de cette fonction
 * 
 * TODO : Faire fonctionner les dropdown "proprement" au lieu d'utiliser ce fichier 
 * ------------------------------------------------------------------------
 */
